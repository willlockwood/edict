...
object LevelHelper {
    ...
    fun getColorResId(level: Int, type: ColorType): Int {
        return when (type) {
    ...
    fun getIconResId(level: Int): Int {
        return when (level) {
            0 -> R.drawable.level_icon_trend_down_black_24dp
            1 -> R.drawable.level_icon_trend_up_black_24dp
            2 -> R.drawable.level_icon_snowflake_white_24dp
            3 -> R.drawable.level_icon_flame_white_24dp
